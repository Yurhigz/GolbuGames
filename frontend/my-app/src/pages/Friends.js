        ...
        <div className="friends-container">
            <div className="friends-left">
                ...
                <div className="invite-form">
                    <Input type="text" placeholder="Nom d'utilisateur" value={friendUsername} />
                    {/*<input*/}
                    {/*    type="text"*/}
                ...
                <div className="section">
                    ...
                    <ul>
                        ...
                        {receivedRequests.length === 0 && <li className="empty-msg">Aucune demande reçue</li>}
                    </ul>
                </div>
                ...
                <div className="section">
                    ...
                    <ul>
                        ...
                        {sentRequests.length === 0 && <li className="empty-msg">Aucune demande envoyée</li>}
                    </ul>
                </div>
